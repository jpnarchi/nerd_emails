...
export const BillingDetailsForm: React.FC<BillingDetailsFormProps> = ({
  ...
  const [validationErrors, setValidationErrors] = useState<Partial<Record<keyof BillingFormData, string>>>({});
        ...
        <div className="md:col-span-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`pl-10 block w-full rounded-lg border ${validationErrors.business_name
